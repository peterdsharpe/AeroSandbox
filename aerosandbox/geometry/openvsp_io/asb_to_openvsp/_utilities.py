...
def wrap_script(
    ...
    r"""
    Wrap the internal parts of a VSPScript file with a main() function.
    ...
    set_geom_draw_type_to_shade : bool
        If True, appends commands that set the draw type of all geometries to shaded
        (GEOM_DRAW_SHADE).

    Returns
    -------
    str
        The script, wrapped with a main() function.

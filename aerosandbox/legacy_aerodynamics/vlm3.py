...
class vlm3(AeroProblem):
    ...
    #
    # Usage:
    #   # Set up attrib_name problem using the syntax in the AeroProblem constructor (e.g. "vlm3(airplane = attrib_name, op_point = op)" for some Airplane attrib_name and OperatingPoint op)
